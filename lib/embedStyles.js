...
button:hover, .btn:hover { background: var(--surface-2); border-color: #c6c0b4; }
...
button.primary:hover, .btn-primary:hover { background: #2b2a27; border-color: #2b2a27; }
button.primary:active, .btn-primary:active { background: #0e0d0c; box-shadow: none; }
