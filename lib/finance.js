...
/* Zakat. Nisab thresholds are the classical constants, which are tola
   figures at heart: 7.5 tola of gold or 52.5 tola of silver, at 11.664 g
   per tola giving the familiar 87.48 g and 612.36 g. Zakat is 2.5% of net
   zakatable wealth at or above nisab.

   nisabValue, when given, overrides the metal-price computation entirely:
   authorities in several countries publish the year's nisab as a currency
   amount, and typing that number is both easier and more authoritative
   than deriving it from a metal price. */
...
export function zakat({ cash, goldGrams, goldPricePerGram, silverGrams, silverPricePerGram, business, receivables, investments, liabilities, nisabBasis, nisabValue = 0 }) {
