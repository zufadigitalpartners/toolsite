...
export const ICONS = {
  ...
  scales:
    '<path d="M12 3v18"/><path d="M8 21h8"/><path d="M5 7h14"/><path d="m6 7-3 6a3.2 3.2 0 0 0 6 0z"/><path d="m18 7-3 6a3.2 3.2 0 0 0 6 0z"/>',
  "moon-star":
    '<path d="M12 3a6.4 6.4 0 0 0 9 9 9 9 0 1 1-9-9z"/><path d="M17 5h4"/><path d="M19 3v4"/>',
  briefcase:
  ...
  coins:
    '<circle cx="8" cy="8" r="5.5"/><path d="M18.1 10.4A5.5 5.5 0 1 1 10.3 18"/><path d="M8 5.5v5"/><path d="M5.5 8h5"/>',

  // crypto
  candlestick:
    '<path d="M7 4v3"/><rect x="5" y="7" width="4" height="7" rx="1"/><path d="M7 14v4"/><path d="M17 6v4"/><rect x="15" y="10" width="4" height="6" rx="1"/><path d="M17 16v3"/>',
  layers:
    '<path d="m12 3 9 5-9 5-9-5z"/><path d="m3 12.5 9 5 9-5"/><path d="m3 17 9 5 9-5"/>',
  waves:
    '<path d="M3 8c2-2 4-2 6 0s4 2 6 0 4-2 6 0"/><path d="M3 13c2-2 4-2 6 0s4 2 6 0 4-2 6 0"/><path d="M3 18c2-2 4-2 6 0s4 2 6 0 4-2 6 0"/>',
  sprout:
    '<path d="M12 21v-8"/><path d="M12 13a6 6 0 0 0-6-6H4a6 6 0 0 0 6 6z"/><path d="M12 11a6 6 0 0 1 6-6h2a6 6 0 0 1-6 6z"/>',
  bitcoin:
    '<circle cx="12" cy="12" r="9"/><path d="M9.5 7.5h4a2 2 0 0 1 0 4h-4z"/><path d="M9.5 11.5h4.5a2 2 0 0 1 0 4H9.5z"/><path d="M9.5 7.5v8"/><path d="M11 5.5v2"/><path d="M11 15.5v2"/>',
  crosshair:
    '<circle cx="12" cy="12" r="8"/><path d="M12 2v4"/><path d="M12 18v4"/><path d="M2 12h4"/><path d="M18 12h4"/>',

  // finance extras
  basket:
    '<path d="m5 11 2-7"/><path d="m19 11-2-7"/><path d="M4 11h16l-1.6 8.4a2 2 0 0 1-2 1.6H7.6a2 2 0 0 1-2-1.6z"/><path d="M9 15v3"/><path d="M15 15v3"/>',
  wallet:
    '<path d="M20 7H5a2 2 0 0 1 0-4h13v4"/><path d="M3 5v14a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-9a1 1 0 0 0-1-1H5"/><path d="M16.5 14h.01"/>',
  "pie-chart":
    '<path d="M12 3a9 9 0 1 0 9 9h-9z"/><path d="M14.5 2.5a9 9 0 0 1 7 7h-7z"/>',
  umbrella:
    '<path d="M12 3a9 9 0 0 1 9 9H3a9 9 0 0 1 9-9z"/><path d="M12 12v6a2 2 0 0 0 4 0"/><path d="M12 3v0"/>',
  "medical-cross": '<path d="M9 3h6v6h6v6h-6v6H9v-6H3V9h6z"/>',
  car:
    '<path d="M5 11l1.5-4.5A2 2 0 0 1 8.4 5h7.2a2 2 0 0 1 1.9 1.5L19 11"/><rect x="3" y="11" width="18" height="6" rx="2"/><circle cx="7.5" cy="17" r="1.8"/><circle cx="16.5" cy="17" r="1.8"/>',

  // health
  apple:
    '<path d="M12 7c-1-2.5-4-3-6-1.5C3.5 7.5 3 11 5 15c1.7 3.4 4 4.8 7 3.3 3 1.5 5.3.1 7-3.3 2-4 1.5-7.5-1-9.5-2-1.5-5-1-6 1.5z"/><path d="M12 7c0-2 1-3.5 3-4"/>',
  utensils:
    '<path d="M7 3v8"/><path d="M4.5 3v5a2.5 2.5 0 0 0 5 0V3"/><path d="M7 11v10"/><path d="M17 3c-1.5 1-2.5 3.2-2.5 6 0 2 1 3 2.5 3v9"/>',
  gauge:
    '<path d="M12 15l3.5-3.5"/><path d="M4 20a9 9 0 1 1 16 0"/><circle cx="12" cy="15" r="1.2"/>',
  ...
  key: '<circle cx="7.5" cy="15.5" r="4"/><path d="m10.5 12.5 8-8"/><path d="m14.5 8.5 3 3"/><path d="m18.5 4.5 1 1"/>',
  building:
    '<rect x="5" y="3" width="14" height="18" rx="1.5"/><path d="M9 7h.01"/><path d="M15 7h.01"/><path d="M9 11h.01"/><path d="M15 11h.01"/><path d="M9 15h.01"/><path d="M15 15h.01"/><path d="M10 21v-3h4v3"/>',
  users:
    '<circle cx="9" cy="8" r="3.5"/><path d="M3 20a6 6 0 0 1 12 0"/><path d="M16.5 4.6a3.5 3.5 0 0 1 0 6.8"/><path d="M17 14.5a6 6 0 0 1 4 5.5"/>',

  // documents
  "file-text":
    '<path d="M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8z"/><path d="M14 3v5h5"/><path d="M9 13h6"/><path d="M9 17h6"/>',
  "clipboard-check":
    '<rect x="5" y="4" width="14" height="17" rx="2"/><path d="M9 4a2 2 0 0 1 6 0"/><path d="m9 13 2 2 4-4"/>',
  "clipboard-list":
    '<rect x="5" y="4" width="14" height="17" rx="2"/><path d="M9 4a2 2 0 0 1 6 0"/><path d="M9 11h6"/><path d="M9 15h6"/>',
  cart:
    '<circle cx="9" cy="20" r="1.5"/><circle cx="17" cy="20" r="1.5"/><path d="M3 4h2l2.5 11.5a2 2 0 0 0 2 1.5h7a2 2 0 0 0 2-1.5L20.5 8H6"/>',
  "undo-arrow": '<path d="M9 14 4 9l5-5"/><path d="M4 9h10a6 6 0 0 1 0 12h-3"/>',
